...
/**
 * Title: Header Media
 * Slug: westernwitch/header-media
 * Categories: westernwitch, header
 */
?>
			...
			<div class="wp-block-media-text alignwide has-media-on-the-right is-stacked-on-mobile is-vertically-aligned-center">
				<div class="wp-block-media-text__content"><!-- wp:group {"layout":{"type":"constrained","contentSize":"600px","justifyContent":"left"}} -->
					<div class="wp-block-group"><!-- wp:paragraph {"align":"left","style":{"typography":{"textTransform":"capitalize","fontStyle":"normal","fontWeight":"400","letterSpacing":"0px"},"spacing":{"margin":{"bottom":"7px"}}},"fontSize":"upper-heading"} -->
						<p class="has-text-align-left has-upper-heading-font-size has-cream-color has-text-color" style="margin-bottom:7px;font-style:normal;font-weight:400;letter-spacing:0px;text-transform:capitalize"><?php esc_html_e('Welcome to WesternWitch', 'westernwitch'); ?></p>
						<!-- /wp:paragraph -->

						<!-- wp:heading {"textAlign":"left","style":{"spacing":{"margin":{"bottom":"0","top":"0px"}},"typography":{"lineHeight":1.3}},"fontSize":"huge"} -->
						<h2 class="wp-block-heading has-text-align-left has-huge-font-size has-cream-color has-text-color" style="margin-top:0px;margin-bottom:0;line-height:1.3"><?php esc_html_e('Lux Treatment!', 'westernwitch'); ?></h2>
						<!-- /wp:heading -->
						...
						<p class="has-text-align-left is-style-default has-gray-color has-text-color" style="margin-top:28px;letter-spacing:2.1px"><?php esc_html_e('Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam', 'westernwitch'); ?></p>
						<!-- /wp:paragraph -->
						...
						<div class="wp-block-buttons" style="margin-top:21px"><!-- wp:button -->
							<div class="wp-block-button"><a class="wp-block-button__link wp-element-button"><?php esc_html_e('JOIN US NOW!', 'westernwitch'); ?></a></div>
							<!-- /wp:button -->
						</div>
						<!-- /wp:buttons -->
					</div>
